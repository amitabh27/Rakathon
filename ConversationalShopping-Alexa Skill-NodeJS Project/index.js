...
//			this.emit(':tell',"Order has been Placed. Please check your registered email id for more details");
	...
	self.emit(':ask',"Although we are earning just a small fragment of the "+product_price +" , we are ready to give up our share and sell you "+product_name+" for only "+parseInt(parseInt(product_price)-((parseInt(product_price)*discount_per)/100)).toString() +" INR. What do you say?");
	}
